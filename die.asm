...
;INTERRUPT HANDLER:
 ORG 0X0004
    ...
    MOVWF PCLATH
    MOVF LFSR,W
    CALL LUT	;FOR FASTER EXECUTION AND BECAUSE WE HAVE A LOT OF UNUSED SPACE ON THE FLASH I'VE OPTED TO USE A LOOKUP TABLE INSTEAD OF CALCULATING LFSR % 6 AND PUTTING THE APROPRIATE SIGNALS ON PORTB
    MOVWF PORTC
